...
// -----------------------------------------------------------------------------
export const getProgress = onRequest({ cors: true }, async (req: Request, res: Response) => {
  try {
...
// HTTP: diagPollStatus
// -----------------------------------------------------------------------------
export const diagPollStatus = onRequest({ cors: true }, async (req: Request, res: Response) => {
  try {
...
// -----------------------------------------------------------------------------
export const diagWhoami = onRequest({ cors: true }, async (req: Request, res: Response) => {
  try {
