const fetchP = (...a) => (global.fetch ? fetch(...a) : import('node-fetch').then(({default:f}) => f(...a)));
...
module.exports = async (req, res) => {
  try{
    ...
    const r = await fetchP(process.env.NX_GRAPHQL_URL || 'https://gqlv2.nexiiot.io/graphql', {
      method: 'POST',
